...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      orgDesc1_3: "<strong>Design & Publication (Outside POLKESMA Work Programs):</strong><br><em>Internal Upgrading X FIKTI Next Generation:</em> Head of HPDD – certificate design, Zoom background, proposals, and PPT.<br><em>FIKTI VISIT:</em> Media Staff – Certificates, banners, documentation, and coordination with 5 external institutions.<br><em>SOSMAS Sharing:</em> Media Staff – Posters & social event documentation.<br><em>A Thread of Hope:</em> Media Staff – Certificates & humanitarian activity documentation.<br><em>FIKTI Student Executive Board General Election:</em> Media Staff – Posters and Instagram campaign feed.",
      orgDate2: "2020 - 2021",
    ...
    id: {
      ...
      orgDesc1_3: "<strong>Desain & Publikasi (Diluar Program Kerja POLKESMA):</strong><br><em>Upgrading Internal X FIKTI Next Generation:</em> Ketua HPDD – desain sertifikat, Zoom background, proposal, dan PPT.<br><em>FIKTI VISIT:</em> Staf Media – Sertifikat, spanduk, dokumentasi, dan koordinasi dengan 5 institusi eksternal.<br><em>SOSMAS Berbagi:</em> Staf Media – Poster & dokumentasi acara sosial.<br><em>Seutas Harapan:</em> Staf Media – Sertifikat & dokumentasi kegiatan kemanusiaan.<br><em>Pemilihan Umum Raya BEM FIKTI:</em> Staf Media – Poster dan Instagram campaign feed.",
      orgDate2: "2020 - 2021",
